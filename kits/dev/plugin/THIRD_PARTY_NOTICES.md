...
- License: licenses/SUPERPOWERS_LICENSE.txt

## Not physically included
GitHub Spec Kit, codebase-memory-mcp, requirements-gap-auditor and verification-before-completion are runtime/shared dependencies in this assembly and are not redistributed by this plugin payload.
