...
- Core: `verification-before-completion`, `codebase-discovery`
- Required: `requirements-gap-auditor`, `requirements-interrogator`, `requirements-quality-check`, `business-rule-extractor`, `srs-function-document`, `document-docx`, `drawio-skill`
- Optional: `product-design-and-ux`, `frontend-design`, `impeccable`, `playwright`, `web-accessibility`
