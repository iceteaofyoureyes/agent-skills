...
description: >-
  Review requirements and SRS artifacts for clarity, completeness,
  consistency, testability and traceability. Use near BA sign-off or after
  SRS generation to identify omissions, contradictions, unsupported
  assumptions, vague requirements and traceability gaps. Distinguish
  confirmed evidence from inference and report concrete findings by severity.
---
