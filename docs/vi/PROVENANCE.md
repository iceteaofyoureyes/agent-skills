...
| srs-function-document; required; srs-function-document/ | PROJECT_OWNED; path nguồn srs-function-document/SKILL.md; không khai báo repository, path hay revision upstream | MIT; Copyright (c) 2026 iceteaofyoureyes | Implementation cũ có origin chưa biết đã được thay bằng behavioral reimplementation mới, do dự án viết từ contract ngữ nghĩa/SRS của BA Kit. Skill mới có LICENSE riêng. | Blob local và benchmark của bản cũ khớp tại fe6b2c9086acd232ac6fe4c8d0d14c66faa714c2; bản đó xuất hiện lần đầu ở commit benchmark 457bfa18d6e9ffe246d9ab2940c036996ec365a4. Không có source record hay URL chứng minh nguồn ban đầu. Không khôi phục được origin cũ. | READY |
...
|---|---|---|---|---|
| 9 exact Addy engineering skills + 1 minimally adapted planner + 5 shared references | addyosmani/agent-skills 0.6.10, commit c004a74784a08295d52749b04cda634125b9a581 | MIT; Copyright (c) 2025 Addy Osmani | 9 skills + 5 refs giữ exact upstream. `planning-and-task-breakdown` upstream blob `296249b...` → local `6705081...` với đúng 2 Human-gate policy-line edits; planning mechanics giữ nguyên. | READY_WITH_ATTRIBUTION for this plugin payload |
...
| GitHub Spec Kit | github/spec-kit v1.0.11, commit 8147943512404afb9d99c6252cb9bf84369fd0b0 | MIT | Runtime dependency cho workflow/state/bundle engine; không dùng core specify/plan/tasks/analyze/converge trong V1 vì chúng phụ thuộc Spec Kit `spec.md`. | NOT_DISTRIBUTED |
