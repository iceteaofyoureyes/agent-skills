...
description: Extract explicit and implicit business rules from source documents, interviews, process notes and verified system behavior. Keep confirmed decisions separate from inferred findings, and surface conflicts and unknowns.
