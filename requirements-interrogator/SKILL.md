...
description: Ask risk-based clarification questions that expose ambiguity, conflicts and hidden assumptions in requirements. Separate missing business decisions from implementation decisions and never answer for the BA.
